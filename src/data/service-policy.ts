export const serviceCarePolicy = {
  everydayHours: 48,
  endOfLeaseDays: 7,
  everydayServices: 'Standard, Deep, Hourly and Move In',
  everydayWindowLabel: '48-hour care promise',
  everydaySupportLabel: '48-hour support',
  everydayFollowUpLabel: '48-hour service follow-up',
  everydayWindow: 'within 48 hours',
  endOfLeaseWindow: 'within seven days',
